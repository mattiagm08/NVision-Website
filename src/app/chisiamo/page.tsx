...
import { Menu, X, Rocket, ShieldCheck, Target, Zap, Globe, Cpu, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export default function ChiSiamo() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-black to-blue-900 text-white font-sans overflow-x-hidden">
      ...
      {/* NAVBAR - Invariata come da richiesta */}
      <header className="fixed top-0 w-full z-50 bg-blue-950/40 backdrop-blur-xl border-b border-blue-400/20 shadow-[0_0_20px_rgba(0,0,80,0.3)]">
        ...
        {menuOpen && (
          <nav className="md:hidden bg-blue-950/95 backdrop-blur-xl px-6 py-7 space-y-4 shadow-xl border-t border-blue-400/20">
            <Link href="/" className="block text-white hover:text-blue-300">Home</Link>
            <Link href="/articoli" className="block text-white hover:text-blue-300">Articoli</Link>
            <Link href="/soluzioni" className="block text-white hover:text-blue-300">Soluzioni</Link>
            <Link href="/chisiamo" className="block text-white hover:text-blue-300">Chi siamo</Link>
      ...
      {/* HERO SECTION - Invariata come da richiesta */}
      ...
      {/* --- AREA DI LAVORO EXCLUSIVE: OUR CORE & BEYOND --- */}
      <section className="py-24 bg-slate-50 text-slate-900 flex-grow relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-700 mb-6 shadow-sm border border-blue-200">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-600"></span>
              </span>
              <span className="text-xs font-bold uppercase tracking-widest">Our Core Philosophy</span>
            </div>
          ...
          {/* Narrative Section: Digital Humanism */}
      ...
      {/* FOOTER - Invariato come da richiesta */}
