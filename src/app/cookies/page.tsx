    ...
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow rounded-lg p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">Gestione delle preferenze</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">Cookie di terze parti</h2>
            <p className="text-gray-600 leading-relaxed">
